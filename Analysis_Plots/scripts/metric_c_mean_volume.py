# -*- coding: utf-8 -*-
"""
metric_c_mean_volume.py
Metric C: mean volume per class (+/- std). Y-axis log scale.
Low-N classes (N < MIN_N) shown with hollow markers.

Outputs:
  fig1C_page_comparison.png
  fig2C_crossgroup_day4.png
  fig3C_timecourse.png
  fig3C_byday.png
"""
...
def fig1C():
    ...
    ax.set_title("Figure 1C -- Mean volume: PAGE (day 3) vs heated conditions (day 4)")
    ax.set_yscale("log")
    ax.set_xlim(-0.6, 15.6)
    fig.tight_layout()
    save_figure(fig, "fig1C_page_comparison.png")
    plt.close(fig)
...
def fig2C():
    ...
    fig.suptitle("Figure 2C -- Mean volume per class: cross-group comparison (day 4)", fontsize=11)
    ...
    fig.tight_layout()
    save_figure(fig, "fig2C_crossgroup_day4.png")
    plt.close(fig)
...
def fig3C():
    ...
    fig.suptitle("Figure 3C -- Mean volume per class over time (per group)", fontsize=11)
    ...
    fig.tight_layout()
    save_figure(fig, "fig3C_timecourse.png")
    plt.close(fig)
...
def fig3C_byday():
    ...
    fig.suptitle("Figure 3C (by day) -- Mean volume vs time (per group)", fontsize=11)
    ...
    save_figure(fig, "fig3C_byday.png")
    plt.close(fig)
